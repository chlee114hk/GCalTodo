...
var globalErrorHandler = require('./api/error');
var bootstrap = require("express-bootstrap-service");

bootstrap.init({
  minified: true,
	resourcePath: __dirname + 'public'
});
...
// Passport
app.use(session({ secret: 'VincentLee', cookie : { maxAge: 3600000 }, saveUninitialized: true, resave: true }));
...
if(USE_API) {
  ...
  */
  ...
  //require('./api/routes')(app, passport);
    var routers = require('./api/routers');
